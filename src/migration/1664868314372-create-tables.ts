...
export class createTables1664868314372 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "tenants" ("id" SERIAL NOT NULL, "tenantName" character varying NOT NULL, "password" character varying NOT NULL, "seasonId" integer NOT NULL DEFAULT '1', "slackId" character varying NOT NULL DEFAULT '', "createdAt" TIMESTAMP(0) NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP(0) NOT NULL DEFAULT now(), CONSTRAINT "UQ_d8b97b02c3fcc38e027a994f78f" UNIQUE ("tenantName"), CONSTRAINT "PK_53be67a04681c66b87ee27c9321" PRIMARY KEY ("id")); COMMENT ON COLUMN "tenants"."id" IS 'テナントID'; COMMENT ON COLUMN "tenants"."tenantName" IS 'テナント名'; COMMENT ON COLUMN "tenants"."password" IS 'テナントパスワード'; COMMENT ON COLUMN "tenants"."seasonId" IS 'シーズンID'; COMMENT ON COLUMN "tenants"."slackId" IS 'slack連携ID'; COMMENT ON COLUMN "tenants"."createdAt" IS '登録日時'; COMMENT ON COLUMN "tenants"."updatedAt" IS '更新日時'`);
