...
export class createTables1665910058318 implements MigrationInterface {
    name = 'createTables1665910058318'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_70b6b760525ef921e37c4a063a"`);
